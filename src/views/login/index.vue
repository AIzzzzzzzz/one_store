...
//准备表单对象
console.log('账户:  heima293');
console.log('密码:  hm#qd@23!');
const from = ref({
    account: '',
    password: '',
    agree: true,
...
const rules = {
    ...
    password: [
        ...
        { min: 6, max: 12, message: '密码长度问题', trigger: 'blur' }
    ],
    agree: [
        {
...
const doLoing = () => {
    ...
    if (account == 13353610096 && password == 123456) {
        router.push({ path: '/' })
    }
                ...
                <div class="account-box">
                    <div class="form">
                        <el-form ref="fromRef" :model="from" :rules="rules" label-position="right" label-width="60px"
                            ...
                            <el-button size="large" class="subBtn" @click="doLoing">点击登录</el-button>
                        </el-form>
                    </div>
                </div>
            </div>
